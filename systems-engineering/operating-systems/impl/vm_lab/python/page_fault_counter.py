...
def main():
    ...
    print(
        f"After allocation (no touch): minflt={minflt_after_alloc}(+{minflt_after_alloc - minflt_before}) majflt={majflt_after_alloc}"
    )
    ...
    print(
        f"After touch: minflt={minflt_after_touch}(+{minflt_after_touch - minflt_after_alloc}) majflt={majflt_after_touch}"
    )
