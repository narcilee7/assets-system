...
| --- | --- |
| LLM system map | todo |
| tokenizer deep dive | todo |
| decoder-only architecture notes | todo |
| long context techniques | todo |
| hallucination taxonomy | todo |
| coding model capability analysis | todo |
